        ...
        754: (e, t, n) => {
          ...
          function g(e) {
            ...
            !i ||
              ...
              (r.endsWith("/") || (r += "/"), (r += i)),
              (n.pathname = r);
            const { jwt: s, lang: o } = e,
              a = new URLSearchParams(n.search);
            s && a.set("jwt", s);
            const { defaultLanguage: c } = e.configOverwrite || {};
            (o || c) && a.set("lang", o || c);
            const l = a.toString();
            l && (n.search = `?${l}`);
            let { hash: p } = n;
            ...
            return (n.hash = p), n.toString() || void 0;
          }
          const m = { window: window.opener || window.parent },
            f = "message";
          class v {
            constructor() {
              let { postisOptions: e } =
              ...
              (this.postis = (function (e) {
                    ...
                    destroy: function (e) {
                      clearInterval(t),
                        ...
                        i &&
                          ...
                          i.removeEventListener("message", h),
                        e && e();
                    },
                  },
                ...
                return (
                  ...
                  u.listen(d, function (e) {
                    if (e === p) {
                      clearInterval(t), (l = !0);
                      for (var n = 0; n < a.length; n++) u.send(a[n]);
                      a = [];
                    } else u.send({ method: d, params: e });
                  }),
                  u
                );
              })({ ...m, ...e })),
                (this._receiveCallback = () => {}),
                this.postis.listen(f, (e) => this._receiveCallback(e));
            }
            dispose() {
              this.postis.destroy();
            }
            ...
            return (
              s.forEach((e) => {
                ...
                try {
                  ...
                  return void c(
                    e,
                    `Failed to parse URL parameter value: ${String(s)}`
                  );
                }
                i[r] = s;
              }),
          ...
          class I extends i() {
            constructor(e) {
              ...
              (this._parentNode = c),
                (this._url = (function (e) {
                  ...
                  devices: f,
                  userInfo: y,
                  appData: { localStorageContent: w },
                })),
                this._createIFrame(a, s, p),
            ...
            _createIFrame(e, t, n) {
              const r = `jitsiConferenceFrame${O}`;
            ...
            _setSize(e, t) {
              ...
              void 0 !== n &&
                ...
                void 0 !== r &&
                  ((this._width = t), (this._frame.style.width = r));
            }
            _setupListeners() {
        ...
        571: (e, t) => {
          ...
          (t.parse = function (e) {
            const r =
                ...
                (arguments.length <= 1 ? void 0 : arguments[1]),
              i =
                (arguments.length <= 1 ? 0 : arguments.length - 1) > 1 || !r
                  ? arguments.length <= 1
                    ? void 0
                    : arguments[1]
                  : void 0,
        ...
        7: (e) => {
          ...
          function s() {
            ...
            if (!(t[s] < e.level))
              for (
                var a =
                    !(e.options.disableCallerInfo || r.disableCallerInfo) &&
                    i(),
            ...
            try {
              ...
              try {
                await (async function (e) {
                  ...
                  r.removeAllRanges(), i.selectNode(n), r.addRange(i);
                  let s = !1;
                  try {
